      ...
      <main className="flex-1 w-full max-w-4xl mx-auto py-12 md:py-16 px-4 sm:px-6 flex flex-col">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-14 border border-gray-100">
          ...
          <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed text-base md:text-lg">
            <p className="mb-4">
              Der Schutz deiner Daten hat für uns höchste Priorität. Da dieses Angebot eine Kooperation zwischen <strong>Liberty Powerhouse</strong> und dem <strong>Dr. Winter und Grocholl Team</strong> ist, gelten die jeweiligen strengen Datenschutzbestimmungen unserer Partner.
            </p>
            <p className="mb-8">
              Ausführliche Informationen zur Verarbeitung deiner Daten (gemäß DSGVO) findest du auf den jeweiligen Unterseiten:
            </p>
            
            <div className="bg-gray-50 rounded-xl p-6 md:p-8 flex flex-col gap-6">
              <a href="https://www.liberty-powerhouse.de/datenschutzerkl%C3%A4rung" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3">
                ...
                <span className="text-[#1B3660] font-semibold group-hover:text-[#D4AF37] transition-colors">
                  Datenschutz Liberty Powerhouse
                </span>
              </a>
              <div className="h-px w-full bg-gray-200"></div>
              <a href="https://drwinter-portfolios.de/datenschutzerklaerung/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3">
                <span className="w-8 h-8 rounded-full bg-[#1B3660]/10 flex items-center justify-center text-[#1B3660] group-hover:bg-[#1B3660] group-hover:text-white transition-colors">
                  &rarr;
                </span>
                <span className="text-[#1B3660] font-semibold group-hover:text-[#D4AF37] transition-colors">
                  Datenschutz Dr. Winter und Grocholl Team
                </span>
              </a>
            </div>
          </div>

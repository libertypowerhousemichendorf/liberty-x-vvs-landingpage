      ...
      <main className="flex-1 w-full max-w-4xl mx-auto py-12 md:py-16 px-4 sm:px-6 flex flex-col">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-14 border border-gray-100">
          ...
          <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed text-base md:text-lg">
            <p className="mb-4">
              Diese Landingpage ist ein gemeinsames Projekt von <strong>Liberty Powerhouse</strong> und dem <strong>Dr. Winter und Grocholl Team</strong>.
            </p>
            <p className="mb-8">
              Für die rechtlichen Pflichtangaben (gemäß § 5 TMG) verweisen wir auf die offiziellen Impressumsseiten unserer Partnerunternehmen:
            </p>
            
            <div className="bg-gray-50 rounded-xl p-6 md:p-8 flex flex-col gap-6">
              <a href="https://www.liberty-powerhouse.de/impressum" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3">
                ...
                <span className="text-[#1B3660] font-semibold group-hover:text-[#D4AF37] transition-colors">
                  Impressum Liberty Powerhouse
                </span>
              </a>
              <div className="h-px w-full bg-gray-200"></div>
              <a href="https://drwinter-portfolios.de/impressum/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3">
                <span className="w-8 h-8 rounded-full bg-[#1B3660]/10 flex items-center justify-center text-[#1B3660] group-hover:bg-[#1B3660] group-hover:text-white transition-colors">
                  &rarr;
                </span>
                <span className="text-[#1B3660] font-semibold group-hover:text-[#D4AF37] transition-colors">
                  Impressum Dr. Winter und Grocholl Team
                </span>
              </a>
            </div>
          </div>
